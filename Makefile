...
JAVA_CMD=java -ea -cp target/CanvasUtils-2.0.0-jar-with-dependencies.jar
...
ship: package
	scp target/CanvasUtils-2.0.0-jar-with-dependencies.jar cis501@eniac.seas.upenn.edu:
